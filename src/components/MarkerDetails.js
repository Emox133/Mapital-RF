...
export default function MarkerDetails({isOpen, onHandleClose, selectedMarker}) {
  ...
  return (
    <div>
      ...
      >
        <DialogTitle id="alert-dialog-slide-title">{selectedMarker && selectedMarker.category}</DialogTitle>
        <DialogContent>
